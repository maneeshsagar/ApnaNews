package com.example.maneeshsagar.apnanews.adapter;
...
import com.example.maneeshsagar.apnanews.ArticleActivity;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
       ...
       AssetManager assetManager = mContext.getApplicationContext().getAssets();
        ...
        public void onClick(View v) {
            ...
            intent.putExtra("Article", (Parcelable) articles.get(getAdapterPosition()));
